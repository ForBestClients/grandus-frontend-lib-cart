...
const ContactForm = ({ countries, towns, contact, contactFormRef, products = [] }) => {
  ...
  const formProps = {
    ...
    initialValues: {
      ...
      createAccount: isEmpty(user) && contact?.createAccount || false,
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        <Box className="mb-8 p-6 border border-alt rounded-2xl overflow-hidden">
          {!isEmpty(user) ? (
            <LoggedUserInfo isSimple />
          ) : (
            <>
                ...
                <div className='grid grid-cols-4 gap-4 pb-4'>
                  ...
                  <div className='col col-span-4'>
                    <SelectInput
                      ...
                      value={toNumber(values?.countryId)}
                      error={
        ...
        {isEmpty(user) ? (
          <Box className="border border-alt rounded-2xl overflow-hidden">
            <div className={`${emailExists ? 'hidden' : 'block'}`}>
              ...
              <div
                className={`mt-3 ${values?.createAccount ? 'block' : 'hidden'}`}
              >
